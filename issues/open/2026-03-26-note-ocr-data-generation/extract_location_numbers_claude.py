...
- Location numbers follow the format XXXX.XX (4 digits, a decimal point, then 1-2 digits), e.g. "0990.77" or "1893.10".
- Writers sometimes insert spaces between digit groups for readability (e.g. "09 90.77" or "18 93.10"). Remove any such spaces and output the number as a single string (e.g. "0990.77", "1893.10").
- Always preserve leading zeros. Output "0990.77" not "990.77". The integer part must be exactly 4 digits (zero-padded if necessary).
